...
function brush(num) {
    ...
    canvas.onmousedown = function(evt) {
        ...
        startX = (evt.pageX - this.offsetLeft-201) * scalePencent;
        startY = (evt.pageY - this.offsetLeft-101) * scalePencent;
        flag = 1;
        // alert(mouseX+'——————————————'+mouseY);
        cxt.closePath();
        cxt.beginPath();
    ...
    canvas.onmousemove = function(evt) {
        evt = evt ? evt : window.event;
        endX = (evt.pageX - this.offsetLeft-201) * scalePencent;
        endY = (evt.pageY - this.offsetLeft-101) * scalePencent;
        // console.log(endX);
...
function straw(num) {
    ...
    canvas.onmousedown = function(evt) {
        evt = evt ? evt : window.event;
        X = (evt.pageX - this.offsetLeft-201) * scalePencent;
        Y = (evt.pageY - this.offsetLeft-101) * scalePencent;
    ...
    if(graphTypes.indexOf(graphType)>-1){
        ...
        if(graphType == 'horizontal'){
            ...
            $("#canvas_bak").die().live("mousedown",function(e) {
                dragging = true;
                iX = e.clientX - this.offsetLeft-201;
                iY = e.clientY - this.offsetLeft-101;
        ...
        var mousedown = function(e) {
            ...
            startX = (e.pageX - this.offsetLeft-201) * scalePencent; // canvasLeft;
            startY = (e.pageY - this.offsetLeft-101) * scalePencent; // canvasTop;
            // console.log(this.offsetLeft-201+" " +this.offsetLeft-101);
...
//            }
        ...
        var mouseup = function(e) {
            // e=e||window.event;
            e = e ? e: window.even;
//            var xx = (e.pageX - this.offsetLeft-201) * scalePencent;// canvasLeft;
//            var yy = (e.pageY - this.offsetLeft-101) * scalePencent;// canvasTop;
            ...
            if (graphType == 'text' || graphType == 'linetext' || graphType == 'squaretext' || graphType == 'circletext') {
                ...
                if (content) {
                    ...
                    // cxt.fillText(content, startX, startY);
                    //cxt.tips(startX, startY, tip_width, 30, 5, content, cxt_bak.fillStyle).stroke();
                    cxt_bak.tips(max_tip_x, max_tip_y, tip_width, 30, 5, content, cxt_bak.fillStyle).stroke();
                    //saveImageToAry();
        ...
        var mousemove = function(e) {
            ...
            var o_x = e.pageX;
            var o_y = e.pageY;
            var x = (e.pageX - this.offsetLeft-201) * scalePencent;// canvasLeft;
            var y = (e.pageY - this.offsetLeft-101) * scalePencent;// canvasTop;
            //console.log(x + " " + y);
...
CanvasRenderingContext2D.prototype.tips = function(x, y, w, h, r, text, color) {
    // if (w < 2 * r) r = w / 2;
    // if (h < 2 * r) r = h / 2;
