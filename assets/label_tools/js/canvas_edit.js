...
//    }
    ...
    if(graphTypes.indexOf(graphType)>-1){
        ...
        var mousedown = function(e) {
            ...
            startX = (e.pageX - this.offsetLeft) * scalePencent; // canvasLeft;
            startY = (e.pageY - this.offsetTop) * scalePencent; // canvasTop;
...
//            var yy = (e.pageY - this.offsetTop) * scalePencent;// canvasTop;
        ...
        var mousemove = function(e) {
            ...
            var o_x = e.pageX;
            var o_y = e.pageY;
            var x = (e.pageX - this.offsetLeft) * scalePencent;// canvasLeft;
            var y = (e.pageY - this.offsetTop) * scalePencent;// canvasTop;
            // console.log(x + " " + y);
