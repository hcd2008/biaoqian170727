/*
	[Foodmate Label System] Copyright (c) 2015-2016 FOODMATE.CN
*/
...
function Dthumb(m, w, h, o, s, i) {
	...
	c += '<form method="post" target="UploadThumb" enctype="multipart/form-data" action="'+DTPath+'upload.php" onsubmit="return isUP(\'upthumb\');"><input type="hidden" name="moduleid" value="'+m+'"/><input type="hidden" name="from" value="thumb"/><input type="hidden" name="old" value="'+o+'"/><input type="hidden" name="fid" value="'+i+'"/><table cellpadding="3"><tr><td><input id="remote_0" type="radio" name="isremote" value="0" checked onclick="ReLo(0, \'upthumb\');"/><label for="remote_0"> '+L['up_local']+'</label><tr id="local_url"><td><input id="upthumb" type="file" size="20" name="upthumb" onchange="if(isImg(\'upthumb\')){this.form.submit();Dd(\'Dsubmit\').disabled=true;Dd(\'Dsubmit\').value=\''+L['uploading']+'\';}"/></td></tr><tr><td><input type="submit" class="btn" value="'+L['upload']+'" id="Dsubmit"/>&nbsp;&nbsp;<input type="button" class="btn" value="'+L['cancel']+'" onclick="cDialog();"/></td></tr></table></form>';
	mkDialog('', c, L['upload_img'], 250);
}
function Dlogo(m, w, h, o, s, i) {
	
	var s = s ? 'none' : ''; var i = i ? i : 'logo'; var c = '<iframe name="Uploadlogo" style="display:none;" src=""></iframe>';
	c += '<form method="post" target="Uploadlogo" enctype="multipart/form-data" action="'+DTPath+'upload.php" onsubmit="return isUP(\'uplogo\');"><input type="hidden" name="moduleid" value="'+m+'"/><input type="hidden" name="from" value="logo"/><input type="hidden" name="old" value="'+o+'"/><input type="hidden" name="fid" value="'+i+'"/><table cellpadding="3" class="ppgl"><tr><td><input id="remote_0" type="radio" name="isremote" value="0" checked onclick="ReLo(0, \'uplogo\');"/><label for="remote_0"> '+L['up_local']+'</label>&nbsp;&nbsp;&nbsp;<input id="remote_1" type="radio" name="isremote" value="1" onclick="ReLo(1, \'uplogo\');"/><label for="remote_1"> '+L['up_remote']+'</label></td></tr><tr id="remote_url" style="display:none;"><td><input id="remote" type="text" size="30" name="remote" value="http://" onclick="if(this.value==\'http://\')this.value=\'\';"/></td></tr><tr id="local_url"><td><input id="uplogo" type="file" size="20" name="uplogo" onchange="if(isImg(\'uplogo\')){this.form.submit();Dd(\'Dsubmit\').disabled=true;Dd(\'Dsubmit\').value=\''+L['uploading']+'\';}"/></td></tr><tr style="display:'+s+'"><td>'+L['width']+' <input type="text" size="3" name="width" value="'+w+'"/> px &nbsp;&nbsp;&nbsp;'+L['height']+' <input type="text" size="3" name="height" value="'+h+'"/> px </td></tr><tr><td><input type="submit" class="btn_pp" value="'+L['upload']+'" id="Dsubmit"/>&nbsp;&nbsp;<input type="button" class="btn_pp" value="'+L['cancel']+'" onclick="cDialog();"/></td></tr></table></form>';
	mkDialog('', c, L['upload_img'], 250);
}
function Dalbum(m, w, h, o, s, i) {
	var s = s ? 'none' : ''; var i = i ? i : 'thumb'; var c = '<iframe name="UploadThumb" style="display:none;" src=""></iframe>';
